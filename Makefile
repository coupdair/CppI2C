...
code:
	geany ReadMe.md Makefile i2c_tools.hpp os_tools.hpp i2c.cpp config.js master.tmpl main.tmpl devices.tmpl page.tmpl view.tmpl i2c-web.cpp web-capture.sh &
...
web: i2c-web.cpp config.js i2c_tools.hpp
	../CppCMS/cppcms/bin/cppcms_tmpl_cc master.tmpl main.tmpl page.tmpl devices.tmpl view.tmpl -o web_skin.cpp
